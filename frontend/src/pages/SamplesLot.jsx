...
const emptyForm = { lot_id: '', lot_code: '', send_date: '', origins: [], estado: 'pendiente', cadmium_mg_kg: '' }
const grainEmptyForm = { origin_id: '', guia_code: '', send_date: '', estado: 'pendiente', cadmium_mg_kg: '' }
        ...
        <div className="card p-6 space-y-4">
          ...
          <form onSubmit={handleGrainSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 flex gap-3 pt-1">
              ...
              <button type="button" onClick={() => { setShowForm(false); setGrainForm({ ...grainEmptyForm }); setEditingGrainId(null) }} className="btn-ghost">Cancelar</button>
            </div>
          </form>
        </div>
      )}
      ...
      {showForm && !currentTab.isGrain && (
        <div className="card p-6 space-y-4">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2 flex gap-3 pt-1">
              <button type="submit" className="btn-primary" disabled={saving}>{saving ? 'Guardando…' : 'Guardar'}</button>
              <button type="button" onClick={() => { setShowForm(false); resetForm() }} className="btn-ghost">Cancelar</button>
            </div>
          </form>
        </div>
      )}
