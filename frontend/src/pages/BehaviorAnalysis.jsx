...
/** Configuración profesional del modebar de Plotly */
      ...
      ? [
          {
            ...
            x1: 1,
            y0: thr,
            y1: Math.max(st.max || thr, thr) * 1.15 || thr + 0.5,
            fillcolor: theme.colors.dangerSoft,
            line: { width: 0 },
            layer: 'below',
          },
        ]
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h1 className="text-2xl font-medium tracking-tight" style={{ color: 'var(--text)' }}>
            {current.label}
          </h1>
          <p className="text-sm mt-1" style={{ color: 'var(--muted)' }}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        {[
          ...
          <div key={k.label} className="card p-4 transition-shadow hover:shadow-md">
            ...
            <p className="text-xl font-semibold mt-1.5 tabular-nums" style={{ color: 'var(--text)' }}>
              {k.value}
            </p>
          </div>
        ))}
                ...
                annotations: [
                  {
                    ...
                    text: `Umbral ${thr}`,
                    showarrow: false,
                    font: { size: 11, color: theme.colors.danger, family: 'Roboto, sans-serif' },
                    xanchor: 'right',
                    yshift: 14,
                  },
                  st.avg != null
                    ? {
                        ...
                        text: `Prom. ${st.avg}`,
                        showarrow: false,
                        font: { size: 10, color: theme.colors.muted, family: 'Roboto, sans-serif' },
                        xanchor: 'left',
                        yshift: 14,
                      }
                    : null,
            ...
            <Plot
              ...
              layout={{
                ...
                xaxis: {
                  ...theme.layout.xaxis,
                  tickangle: -38,
                  tickfont: { size: 10, color: theme.colors.softText },
                },
            ...
            <div className="card p-5 chart-card">
              ...
              <Plot
                ...
                layout={{
                  ...
                  margin: { t: 20, r: 36, b: 52, l: 140 },
                  bargap: 0.32,
                  xaxis: {
                    ...theme.layout.xaxis,
                    title: {
                      text: 'Cd promedio (mg/kg)',
                      font: { color: theme.colors.softText, size: 12 },
                    },
                  },
                  yaxis: {
                    ...theme.layout.yaxis,
                    title: undefined,
                    automargin: true,
                    tickfont: { size: 11, color: theme.colors.softText },
                  },
                  shapes: [
                    {
                      type: 'line',
                ...
                config={{ ...plotConfigOrigin, displayModeBar: true }}
                style={{ width: '100%' }}
                useResizeHandler
                className="plotly-professional"
              />
